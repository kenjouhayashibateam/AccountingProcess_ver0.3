...
namespace Infrastructure
{
    public class LocalConnectInfrastructure : IDataBaseConnect
    {
                ...
                DateTime outputDateStart,DateTime OutputDateEnd)
        {
            ...
            AccountingSubject OtherTyadokoroIncome = 
                new AccountingSubject("accounting_subject2", "822", "その他茶所収入", true);
            AccountingSubject SuspenseReceiptMoney = 
                new AccountingSubject("accounting_subject2", "822", "仮受金", true);
            AccountingSubject TravelExpense =
                new AccountingSubject("accounting_subject2", "822", "旅費交通費", true);
            AccountingSubject SuppliesExpense =
                new AccountingSubject("accounting_subject2", "822", "消耗品費", true);
            AccountingSubject VehicleFee = new AccountingSubject
                ("accounting_subject2", "822", "車両費", true);
            AccountingSubject InternalMaintenanceExpenses = 
                new AccountingSubject("accounting_subject2", "822", "苑内整備費", true);
            AccountingSubject SuspensePayment =
                new AccountingSubject("accounting_subject2", "822", "仮払金", true);
            AccountingSubject Seresa =
                new AccountingSubject("accounting_subject2", "822","セレサ川崎普通貯金", true);
